...
int main(int argc, char** argv) {
   ...
   sdds::Dictionary pData[]{
       ...
       sdds::Dictionary("pollution", "An introduction into the environment of "
                                     "a substance that has harmful effect"),
       sdds::Dictionary("slide", "a structure with a smooth sloping surface "
                                 "for children to slide down."),
       sdds::Dictionary("complete",
